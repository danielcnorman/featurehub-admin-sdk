...
module FeaturehubAdminSdk
  class RolloutStrategy
    ...
    attr_accessor :percentage_attributes
    ...
    def self.attribute_map
      {
        ...
        :'percentage_attributes' => :'percentageAttributes',
        :'value' => :'value',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FeaturehubAdminSdk::RolloutStrategy` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FeaturehubAdminSdk::RolloutStrategy`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'percentage_attributes')
        if (value = attributes[:'percentage_attributes']).is_a?(Array)
          self.percentage_attributes = value
        end
      end
      ...
      if attributes.key?(:'colouring')
        self.colouring = attributes[:'colouring']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          percentage_attributes == o.percentage_attributes &&
          value == o.value &&
          attributes == o.attributes &&
          name == o.name &&
          colouring == o.colouring &&
          avatar == o.avatar
    end
    ...
    def hash
      [id, percentage, percentage_attributes, value, attributes, name, colouring, avatar].hash
    end
